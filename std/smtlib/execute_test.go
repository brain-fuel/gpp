...
func TestExecuteIntegerSortedFunctionCongruence(t *testing.T) {
...
(assert (= x y))
(assert (not (= (combine x y) (combine y x))))
(check-sat)`,
	} {
		result, ok := Execute(source).(Executed)
		if !ok {
...
func TestExecuteRealPredicateCongruence(t *testing.T) {
	for _, source := range []string{
		`(set-logic QF_UFLRA)
(declare-const x Real)
(declare-const y Real)
...
func TestExecuteAffineIntegerRealComparisons(t *testing.T) {
	source := `(set-logic QF_LIRA)
(declare-const x Int)
(declare-const y Int)
(assert (= x 3))
(assert (= y 4))
(assert (= (+ (to_real x) 1.5) (+ (to_real y) 0.5)))
(assert (< (+ (to_real x) 1.5) (+ (to_real y) 1.0)))
(assert (not (< (+ (to_real y) 1.0) (+ (to_real x) 1.5))))
(check-sat)`
	result, ok := Execute(source).(Executed)
	if !ok {
		t.Fatalf("result=%#v", Execute(source))
...
(assert (= x 2))
(assert (= y 3))
(assert (= (to_int (* 1.5 (+ (to_real x) (to_real y) 0.25))) 7))
(assert (not (is_int (* 1.5 (+ (to_real x) (to_real y) 0.25)))))
(check-sat)`,
	} {
		result, ok := Execute(source).(Executed)
		if !ok {
...
func TestExecuteUnconstrainedFloatingPointOrdering(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 15 113))
(declare-const right (_ FloatingPoint 15 113))
(assert (fp.lt left right))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained order did not use the streaming executor")
	}
...
func TestExecuteFloatingPointSub(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp.sub RNE ((_ to_fp 8 24) #x40700000)
              ((_ to_fp 8 24) #x40100000))) #x3fc00000))
(assert (= (fp.to_ieee_bv
  (fp.sub RTN ((_ to_fp 8 24) #x3f800000)
              ((_ to_fp 8 24) #x3f800000))) #x80000000))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteAndStreamSymbolicFloatingPointSub(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv left) #x40700000))
(assert (= (fp.to_ieee_bv right) #x40100000))
(assert (= (fp.to_ieee_bv (fp.sub RNE left right)) #x3fc00000))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("fp.sub script did not use streaming execution")
	}
...
func TestExecuteUnconstrainedFloatingPointSub(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const zero-left (_ FloatingPoint 8 24))
(declare-const zero-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.sub RNE left right)) #x3fc00000))
(assert (= (fp.to_ieee_bv (fp.sub RTN zero-left zero-right)) #x80000000))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained fp.sub script did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("streaming execution=%#v", fast)
...
func TestRejectIllSortedFloatingPointSub(t *testing.T) {
	script := `(assert (= (fp.to_ieee_bv
  (fp.sub RNE ((_ to_fp 8 24) #x3f800000)
              ((_ to_fp 5 11) #x3c00))) #x00000000))`
	if _, ok := Execute(script).(ExecutionFailed); !ok {
		t.Fatalf("mixed fp.sub formats unexpectedly succeeded")
	}
}

func TestExecuteFloatingPointMul(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp.mul RNE ((_ to_fp 8 24) #x3fc00000)
              ((_ to_fp 8 24) #x40100000))) #x40580000))
(assert (fp.isNaN
  (fp.mul RNE (_ +oo 8 24) (_ -zero 8 24))))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteAndStreamSymbolicFloatingPointMul(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv left) #x3fc00000))
...
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("fp.mul script did not use streaming execution")
	}
	for name, execution := range map[string]ExecutionResult{
		"stream": fast,
		"public": Execute(script),
...
func TestExecuteUnconstrainedFloatingPointMul(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const zero-left (_ FloatingPoint 8 24))
(declare-const zero-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.mul RNE left right)) #x40580000))
(assert (= (fp.to_ieee_bv (fp.mul RTN zero-left zero-right)) #x80000000))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained fp.mul script did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("streaming execution=%#v", fast)
...
func TestRejectIllSortedFloatingPointMul(t *testing.T) {
	script := `(assert (= (fp.to_ieee_bv
  (fp.mul RNE ((_ to_fp 8 24) #x3f800000)
              ((_ to_fp 5 11) #x3c00))) #x00000000))`
	if _, ok := Execute(script).(ExecutionFailed); !ok {
		t.Fatalf("mixed fp.mul formats unexpectedly succeeded")
	}
}
...
func TestExecuteUnconstrainedFloatingPointDiv(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const zero-left (_ FloatingPoint 8 24))
(declare-const zero-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.div RNE left right)) #x3eaaaaab))
(assert (= (fp.to_ieee_bv (fp.div RTN zero-left zero-right)) #x80000000))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained fp.div script did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("streaming execution=%#v", fast)
...
func TestExecuteFloatingPointFMA(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp.fma RNE ((_ to_fp 8 24) #x3f800001)
              ((_ to_fp 8 24) #x3f7fffff)
              ((_ to_fp 8 24) #xbf800000))) #x337ffffe))
(assert (fp.isNaN
  (fp.fma RNE (_ +oo 8 24) (_ +zero 8 24)
              ((_ to_fp 8 24) #x3f800000))))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
...
func TestExecuteAndStreamSymbolicFloatingPointFMA(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
...
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("fp.fma script did not use streaming execution")
	}
	for name, execution := range map[string]ExecutionResult{
		"stream": fast,
		"public": Execute(script),
...
func TestRejectIllSortedFloatingPointFMA(t *testing.T) {
  ...
  (fp.fma RNE ((_ to_fp 8 24) #x3f800000)
              ...
              ((_ to_fp 5 11) #x3c00))) #x00000000))`
	if _, ok := Execute(script).(ExecutionFailed); !ok {
		t.Fatalf("mixed fp.fma formats unexpectedly succeeded")
	}
}

func TestExecuteFloatingPointSqrt(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp.sqrt RNE ((_ to_fp 8 24) #x40000000))) #x3fb504f3))
(assert (fp.isNaN
  (fp.sqrt RNE ((_ to_fp 8 24) #xbf800000))))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteAndStreamSymbolicFloatingPointSqrt(t *testing.T) {
	script := `(set-logic QF_FP)
...
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("fp.sqrt script did not use streaming execution")
	}
	for name, execution := range map[string]ExecutionResult{
		"stream": fast,
		"public": Execute(script),
...
func TestExecuteUnconstrainedFloatingPointSqrt(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const value (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.sqrt RNE value)) #x3fb504f3))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained fp.sqrt script did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("streaming execution=%#v", fast)
...
func TestRejectIllSortedFloatingPointSqrt(t *testing.T) {
	script := `(assert (= (fp.to_ieee_bv
  (fp.sqrt ((_ to_fp 8 24) #x3f800000) RNE)) #x3f800000))`
	if _, ok := Execute(script).(ExecutionFailed); !ok {
		t.Fatalf("ill-sorted fp.sqrt unexpectedly succeeded")
	}
}
...
(assert (= ((_ fp.to_sbv 8) RNE ((_ to_fp 8 24) #xbfc00000)) #xfe))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteSymbolicFloatingPointToBitVector(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const x (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv x) #xbfc00000))
(assert (= ((_ fp.to_sbv 8) RNE x) #xfe))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteUnconstrainedFloatingPointToBitVector(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const x (_ FloatingPoint 8 24))
(assert (= ((_ fp.to_sbv 8) RNE x) #xfd))
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("unconstrained fp.to_bv did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("streaming execution=%#v", fast)
...
func TestStreamFloatingPointToBitVector(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const x (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv x) #xbfc00000))
(assert (= ((_ fp.to_sbv 8) RNE x) #xfe))
(check-sat)`
	result, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("floating-point conversion did not use streaming execution")
	}
	executed, ok := result.(Executed)
	if !ok {
		t.Fatalf("execute=%#v", result)
...
func TestRejectIllSortedFloatingPointToBitVector(t *testing.T) {
	for _, script := range []string{
		`(assert (= ((_ fp.to_ubv 0) RNE ((_ to_fp 8 24) #x3f800000)) #b0))`,
		`(assert (= ((_ fp.to_sbv 8) #b0 ((_ to_fp 8 24) #x3f800000)) #x01))`,
		`(assert (= ((_ fp.to_ubv 8) RNE #x3f800000) #x01))`,
	} {
		if _, ok := Execute(script).(ExecutionFailed); !ok {
...
func TestExecuteFloatingPointFormatConversion(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  ((_ to_fp 5 11) RNE ((_ to_fp 8 24) #x3f801000))) #x3c00))
(assert (= (fp.to_ieee_bv
  ((_ to_fp 5 11) RNA ((_ to_fp 8 24) #x3f801000))) #x3c01))
(assert (= (fp.to_ieee_bv
  ((_ to_fp 8 24) RNE (_ -zero 5 11))) #x80000000))
(check-sat)`
	result, ok := Execute(script).(Executed)
	if !ok {
		t.Fatalf("execute=%#v", Execute(script))
...
func TestExecuteSymbolicFloatingPointFormatConversion(t *testing.T) {
	script := `(set-logic QF_FP)
(declare-const x (_ FloatingPoint 8 24))
...
(check-sat)`
	...
	if !ok {
		t.Fatal("streaming executor rejected supported format conversion")
	}
	executed, ok := result.(Executed)
	if !ok {
		t.Fatalf("execute=%#v", result)
...
func TestRejectIllSortedFloatingPointFormatConversion(t *testing.T) {
	for _, script := range []string{
		`(assert (= (fp.to_ieee_bv ((_ to_fp 5 11) #b0 (_ +zero 8 24))) #x0000))`,
		`(assert (= (fp.to_ieee_bv ((_ to_fp_unsigned 5 11) RNE (_ +zero 8 24))) #x0000))`,
	} {
		if _, ok := Execute(script).(ExecutionFailed); !ok {
...
(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp #b0 #b01111111 #b00000000000000000000000)) #x3f800000))
(assert (= (fp.to_ieee_bv (_ +zero 8 24)) #x00000000))
(assert (= (fp.to_ieee_bv (_ -zero 8 24)) #x80000000))
(assert (= (fp.to_ieee_bv (_ +oo 8 24)) #x7f800000))
(assert (= (fp.to_ieee_bv (_ -oo 8 24)) #xff800000))
...
func TestStreamFloatingPointNativeConstructorAndSpecialValues(t *testing.T) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp #b0 #b01111111 #b00000000000000000000000)) #x3f800000))
(assert (= (fp.to_ieee_bv (_ -zero 8 24)) #x80000000))
...
(check-sat)`
	fast, recognized := executeFloatingPointFast(script)
	if !recognized {
		t.Fatal("native floating-point construction script did not use streaming execution")
	}
	result, ok := fast.(Executed)
	if !ok {
		t.Fatalf("fast=%#v", fast)
...
func TestExecuteSymbolicFloatingPointNativeConstructor(t *testing.T) {
	script := `
(set-logic QF_FPBV)
(declare-const sign (_ BitVec 1))
(declare-const exponent (_ BitVec 8))
(declare-const significand (_ BitVec 23))
(assert (= sign #b0))
(assert (= exponent #x7f))
(assert (= significand #b00000000000000000000000))
(assert (= (fp.to_ieee_bv (fp sign exponent significand)) #x3f800000))
(check-sat)
`
	result, ok := Execute(script).(Executed)
	if !ok {
...
func TestRejectIllSortedFloatingPointNativeConstruction(t *testing.T) {
	scripts := []string{
		`(assert (fp.isZero (fp #b00 #b00000000 #b00000000000000000000000)))`,
		`(assert (fp.isZero (fp #b0 #b0 #b0)))`,
		`(assert (fp.isZero (_ +zero 1 24)))`,
		`(assert (fp.isZero (_ NaN 8 1)))`,
	}
	for _, script := range scripts {
		if _, ok := Execute(script).(ExecutionFailed); !ok {
			t.Fatalf("Execute(%q) unexpectedly succeeded", script)
...
func BenchmarkExecuteUnconstrainedFloatingPointOrdering(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const upper (_ FloatingPoint 8 24))
...
func BenchmarkExecuteFloatingPointConstruction(b *testing.B) {
	script := `(set-logic QF_FP)
(assert (= (fp.to_ieee_bv
  (fp #b0 #b01111111 #b00000000000000000000000)) #x3f800000))
(assert (= (fp.to_ieee_bv (_ -zero 8 24)) #x80000000))
...
func BenchmarkExecuteFloatingPointSub(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv left) #x40700000))
...
func BenchmarkExecuteUnconstrainedFloatingPointSub(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const second-left (_ FloatingPoint 8 24))
(declare-const second-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.sub RNE left right)) #x3fc00000))
(assert (= (fp.to_ieee_bv (fp.sub RTN second-left second-right)) #xbfc00000))
(check-sat)`
	b.Run("stream", func(b *testing.B) {
		b.ReportAllocs()
		for b.Loop() {
...
func BenchmarkExecuteFloatingPointMul(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv left) #x3fc00000))
...
func BenchmarkExecuteUnconstrainedFloatingPointMul(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const second-left (_ FloatingPoint 8 24))
(declare-const second-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.mul RNE left right)) #x40580000))
(assert (= (fp.to_ieee_bv (fp.mul RTN second-left second-right)) #xc0580000))
(check-sat)`
	b.Run("stream", func(b *testing.B) {
		b.ReportAllocs()
		for b.Loop() {
...
func BenchmarkExecuteUnconstrainedFloatingPointDiv(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const second-left (_ FloatingPoint 8 24))
(declare-const second-right (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.div RNE left right)) #x3eaaaaab))
(assert (= (fp.to_ieee_bv (fp.div RTN second-left second-right)) #xbeaaaaab))
(check-sat)`
	b.Run("stream", func(b *testing.B) {
		b.ReportAllocs()
		for b.Loop() {
...
func BenchmarkExecuteFloatingPointFMA(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const left (_ FloatingPoint 8 24))
(declare-const right (_ FloatingPoint 8 24))
(declare-const addend (_ FloatingPoint 8 24))
...
func BenchmarkExecuteFloatingPointSqrt(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const value (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv value) #x40000000))
(assert (= (fp.to_ieee_bv (fp.sqrt RNE value)) #x3fb504f3))
...
func BenchmarkExecuteUnconstrainedFloatingPointSqrt(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const exact (_ FloatingPoint 8 24))
(declare-const irrational (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv (fp.sqrt RNE exact)) #x40000000))
(assert (= (fp.to_ieee_bv (fp.sqrt RNE irrational)) #x3fb504f3))
(check-sat)`
	b.Run("stream", func(b *testing.B) {
		b.ReportAllocs()
		for b.Loop() {
...
func BenchmarkExecuteFloatingPointToBitVector(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const value (_ FloatingPoint 8 24))
...
func BenchmarkExecuteUnconstrainedFloatingPointToBitVector(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const signed8 (_ FloatingPoint 8 24))
(declare-const unsigned8 (_ FloatingPoint 8 24))
(declare-const signed16 (_ FloatingPoint 8 24))
(declare-const unsigned32 (_ FloatingPoint 8 24))
(assert (= ((_ fp.to_sbv 8) RNE signed8) #xfd))
(assert (= ((_ fp.to_ubv 8) RTZ unsigned8) #x03))
(assert (= ((_ fp.to_sbv 16) RTP signed16) #xff80))
(assert (= ((_ fp.to_ubv 32) RTN unsigned32) #x01000000))
(check-sat)`
	b.Run("stream", func(b *testing.B) {
		b.ReportAllocs()
		for b.Loop() {
...
func BenchmarkExecuteFloatingPointFormatConversion(b *testing.B) {
	script := `(set-logic QF_FP)
(declare-const x (_ FloatingPoint 8 24))
(assert (= (fp.to_ieee_bv x) #x3f801000))
(assert (= (fp.to_ieee_bv ((_ to_fp 5 11) RNE x)) #x3c00))
