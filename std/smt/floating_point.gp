...
func FloatingPointConvertFormat(targetExponentBits nat, targetSignificandBits nat, 0 e nat, 0 s nat, mode FloatingPointRoundingMode, value FloatingPointValue[e, s]) FloatingPointValue[targetExponentBits, targetSignificandBits] {
...
func FloatingPointFromRational(exponentBits nat, significandBits nat, mode FloatingPointRoundingMode, value Rational) FloatingPointValue[exponentBits, significandBits] {
...
func FloatingPointToRational(0 e nat, 0 s nat, value FloatingPointValue[e, s]) (Rational, bool) {
...
// valid floating-point formats.
func FloatingPointSub(0 e nat, 0 s nat, mode FloatingPointRoundingMode, left FloatingPointValue[e, s], right FloatingPointValue[e, s]) FloatingPointValue[e, s] {
...
func FloatingPointRem(0 e nat, 0 s nat, left FloatingPointValue[e, s], right FloatingPointValue[e, s]) FloatingPointValue[e, s] {
...
func FloatingPointToUnsignedBitVector(0 e nat, 0 s nat, width nat, mode FloatingPointRoundingMode, value FloatingPointValue[e, s]) (BitVectorValue, bool) {
...
// result is false exactly when SMT-LIB leaves the conversion result unspecified.
func FloatingPointToSignedBitVector(0 e nat, 0 s nat, width nat, mode FloatingPointRoundingMode, value FloatingPointValue[e, s]) (BitVectorValue, bool) {
