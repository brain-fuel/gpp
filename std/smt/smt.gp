...
//goplus:derive off
type SequenceSort[E any] enum {
	sequenceSort() SequenceSort[E]
}
...
type Term[S any] enum {
	...
	stringSymbol(ID int, Name string) Term[S]
	stringConcat(Values []Term[StringSort]) Term[S]
	stringLength(Value Term[StringSort]) Term[IntSort]
	...
	datatypeMixedSelector(DatatypeID int, ConstructorCount int, ConstructorID int, Field int, FieldKind int, Width int, TargetDatatypeID int, TargetConstructorCount int, ConstructorName string, SelectorName string, Specs MixedDatatypeFieldSpecs, Value any) Term[S]
	datatypeMixedUpdate(DatatypeID int, ConstructorCount int, ConstructorID int, Field int, FieldKind int, Width int, TargetDatatypeID int, TargetConstructorCount int, Specs MixedDatatypeFieldSpecs, Replacement any, Value any) Term[S]
...
func UpdateMixedBoolDatatypeField(0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(BoolDatatypeFieldSort, tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[BoolSort]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldBool, 0, 0, 0, cursor, value, replacement) }
func UpdateMixedIntDatatypeField(0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(IntDatatypeFieldSort, tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[IntSort]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldInt, 0, 0, 0, cursor, value, replacement) }
func UpdateMixedRealDatatypeField(0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(RealDatatypeFieldSort, tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[RealSort]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldReal, 0, 0, 0, cursor, value, replacement) }
func UpdateMixedBitVecDatatypeField(width nat, 0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(BitVecDatatypeFieldSort(width), tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[BitVecSort[width]]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldBitVec, int(width), 0, 0, cursor, value, replacement) }
func UpdateMixedSelfDatatypeField(0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(SelfDatatypeFieldSort, tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[DatatypeSort[datatype, constructors]]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldSelf, 0, 0, 0, cursor, value, replacement) }
func UpdateMixedDatatypeReferenceField(targetDatatype nat, targetConstructors nat, 0 datatype nat, 0 constructors nat, 0 constructor nat, 0 tail DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, DatatypeFieldCons(DatatypeReferenceFieldSort(targetDatatype, targetConstructors), tail)], value Term[DatatypeSort[datatype, constructors]], replacement Term[DatatypeSort[targetDatatype, targetConstructors]]) Term[DatatypeSort[datatype, constructors]] { return updateMixedDatatypeField(mixedDatatypeFieldReference, 0, int(targetDatatype), int(targetConstructors), cursor, value, replacement) }

func selectMixedDatatypeField[S any](kind int, width int, targetDatatypeID int, targetConstructorCount int, 0 datatype nat, 0 constructors nat, 0 constructor nat, 0 fields DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, fields], value Term[DatatypeSort[datatype, constructors]]) Term[S] { match cursor { case mixedDatatypeCursorValue(declaration, offset): match declaration { case mixedRecursiveDatatypeConstructorValue(datatypeID, constructorCount, constructorID, name, specs): spec := specs.At(offset); if spec.Kind != kind || spec.Width != width || spec.DatatypeID != targetDatatypeID || spec.ConstructorCount != targetConstructorCount { panic("smt: erased mixed datatype cursor sort mismatch") }; return Term[S].datatypeMixedSelector(datatypeID, constructorCount, constructorID, offset, kind, width, targetDatatypeID, targetConstructorCount, name, spec.Name, specs, value) } } }
func updateMixedDatatypeField[R any](kind int, width int, targetDatatypeID int, targetConstructorCount int, 0 datatype nat, 0 constructors nat, 0 constructor nat, 0 fields DatatypeFieldList, cursor MixedDatatypeCursor[datatype, constructors, constructor, fields], value Term[DatatypeSort[datatype, constructors]], replacement Term[R]) Term[DatatypeSort[datatype, constructors]] { match cursor { case mixedDatatypeCursorValue(declaration, offset): match declaration { case mixedRecursiveDatatypeConstructorValue(datatypeID, constructorCount, constructorID, _, specs): spec := specs.At(offset); if spec.Kind != kind || spec.Width != width || spec.DatatypeID != targetDatatypeID || spec.ConstructorCount != targetConstructorCount { panic("smt: erased mixed datatype update sort mismatch") }; return Term[DatatypeSort[datatype, constructors]].datatypeMixedUpdate(datatypeID, constructorCount, constructorID, offset, kind, width, targetDatatypeID, targetConstructorCount, specs, replacement, value) } } }
...
func DeclareRealPredicate(id int, name string) SortedUnaryFunction[RealSort, BoolSort] {
	return SortedUnaryFunction[RealSort, BoolSort].sortedUnaryFunctionValue(-1, -3, id, name)
}
...
func DeclareRealBinaryPredicate(id int, name string) SortedBinaryFunction[RealSort, RealSort, BoolSort] {
	return SortedBinaryFunction[RealSort, RealSort, BoolSort].sortedBinaryFunctionValue(-1, -1, -3, id, name)
}
...
func DeclareRealTernaryFunction(id int, name string) SortedTernaryFunction[RealSort, RealSort, RealSort, RealSort] {
	return SortedTernaryFunction[RealSort, RealSort, RealSort, RealSort].sortedTernaryFunctionValue(-1, -1, -1, -1, id, name)
}
